...
foam-extend-5.0    : Test harness for foam-extend version 5.0. See the file foam-extend-5.0/README.txt for more information
...
5: move to the runDir directory for the FOAM test harness
   ...
   cd $WM_PROJECT_DIR/testHarness/foam-extend/5.0/runDir
...
7:   Next, running the test loop is pretty simple:
   ...
   cd $WM_PROJECT_DIR/testHarness/foam-extend/5.0/runDir # you should already be there...
   ./Allclean
   ./Allrun_Experimental
...
8: The results will be published on the CDash dashboard on foam-extend.
   ...
   To see your results:
   URL      : http://foam-extend.sourceforge.net/CDash/index.php?project=foam-extend-5.0
...
10: In general, see the file $WM_PROJECT_DIR/testHarness/foam-extend/5.0/README.txt for the necessary information about running the
    test loop.
