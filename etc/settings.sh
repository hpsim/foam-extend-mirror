...
# These sre the Default locations for pre-installed version of the ThirdParty
# packages. Those values are based on Ubuntu 20.04
# Use the file prefs.sh to pre-initialize to different default values, accordingly to
# your Linux/Unix flavour
: ${WM_SYSTEM_DIR:=/usr};                 export WM_SYSTEM_DIR
: ${WM_SYSTEM_BIN_DIR:=/usr/bin};         export WM_SYSTEM_BIN_DIR
: ${WM_SYSTEM_LIB_DIR:=/lib};             export WM_SYSTEM_LIB_DIR
: ${WM_SYSTEM_INCLUDE_DIR:=/usr/include}; export WM_SYSTEM_INCLUDE_DIR
